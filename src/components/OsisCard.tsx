...
const OsisCard = ({ id, name, img, osisVoteHandler, osisValue }: OsisCardProps) => {
    ...
    return (
        <div onClick={() => {clicked(); console.log("clicked")}} className={`${osisValue === id ? "border-2 border-[#aaaaaa] " : ""}flex flex-col w-full h-fit bg-gradient-to-b from-[#232741] to-[#161A20] rounded-2xl pt-2 px-2 transition transform ease-in active:scale-99`}>
